...
public class QSHKPSPublicSoap
{
    ...
    public QSHKPSPublicSoap(){}

    public QSHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QSHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QSHExtendedSoapSerializationEnvelope envelope= new QSHExtendedSoapSerializationEnvelope(QSHExtendedSoapSerializationEnvelope.VER11);
